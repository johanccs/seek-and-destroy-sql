...
export const ROADMAP: RoadmapLevel[] = [
  {
    ...
    entries: [
      ...
      { n: 6, title: "One-to-one, and when it's really inheritance", blurb: "A rarer shape that usually means something else is going on." },
      { n: 7, title: "Many-to-many and the junction table", blurb: "Why the engine has no direct way to store this, and what to do instead." },
