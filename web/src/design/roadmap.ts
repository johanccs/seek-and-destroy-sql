...
export const ROADMAP: RoadmapLevel[] = [
  ...
  },
  {
    ...
    entries: [
      { n: 11, id: "d-i-11-why-normalize", title: "Why normalize — the anomalies", blurb: "Update, insert and delete anomalies shown live, before any rule is named." },
      { n: 12, id: "d-i-12-first-normal-form", title: "1NF: repeating groups", blurb: "Phone1, Phone2, Phone3 — and the comma-separated column that is just as bad." },
      { n: 13, id: "d-i-13-second-normal-form", title: "2NF: partial dependencies", blurb: "Attributes that depend on only part of a composite key." },
      { n: 14, id: "d-i-14-third-normal-form", title: "3NF: transitive dependencies", blurb: "Facts about a fact, and the lookup table they belong in." },
      { n: 15, id: "d-i-15-bcnf", title: "BCNF: when 3NF isn't enough", blurb: "The overlapping-candidate-key case that 3NF lets through." },
