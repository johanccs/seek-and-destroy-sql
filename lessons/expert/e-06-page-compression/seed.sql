...
IF DB_ID('Lesson_e_06_page_compression') IS NOT NULL
BEGIN
    ALTER DATABASE Lesson_e_06_page_compression SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE Lesson_e_06_page_compression;
END
GO
CREATE DATABASE Lesson_e_06_page_compression;
GO
USE Lesson_e_06_page_compression;
GO
...
INSERT INTO dbo.Orders (CustomerId, OrderDate, Total, Status, Region)
SELECT (rn % 5000) + 1,
