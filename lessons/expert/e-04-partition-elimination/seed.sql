...
IF DB_ID('Lesson_e_04_partition_elimination') IS NOT NULL
BEGIN
    ALTER DATABASE Lesson_e_04_partition_elimination SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE Lesson_e_04_partition_elimination;
END
GO
CREATE DATABASE Lesson_e_04_partition_elimination;
GO
USE Lesson_e_04_partition_elimination;
GO
