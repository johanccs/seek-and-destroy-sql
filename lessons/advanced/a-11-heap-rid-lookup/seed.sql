...
IF DB_ID('Lesson_a_11_heap_rid_lookup') IS NOT NULL
BEGIN
    ALTER DATABASE Lesson_a_11_heap_rid_lookup SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE Lesson_a_11_heap_rid_lookup;
END
GO
CREATE DATABASE Lesson_a_11_heap_rid_lookup;
GO
USE Lesson_a_11_heap_rid_lookup;
GO
